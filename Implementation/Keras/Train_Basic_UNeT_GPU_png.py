...
if Resume==True:
    kmodel=keras.models.load_model('Unet_Basic_Checkpoint.h5',custom_objects={'root_mean_squared_error': root_mean_squared_error,'PSNR': PSNR}) #Load model
    if Recompile==True:
...
callbacks = [
    keras.callbacks.ModelCheckpoint("Unet_Basic_Checkpoint.h5",save_best_only=True)
]
